...
export function valueOf<T1, T2, T3>(value1: Value<T1>, value2: Value<T2>, value3: Value<T3>): [ValueOf<T1>, ValueOf<T2>, ValueOf<T3>]
export function valueOf<T1, T2, T3, T4>(value1: Value<T1>, value2: Value<T2>, value3: Value<T3>, value4: Value<T4>): [ValueOf<T1>, ValueOf<T2>, ValueOf<T3>, ValueOf<T4>]
