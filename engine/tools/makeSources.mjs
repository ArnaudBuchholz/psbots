...
const GENERATED_FILE_HEADER = '// ⚠️ This file is generated by tools/makeSources.mjs, ✋ do not modify\n\n';
...
async function generateExceptions() {
  ...
  writeFile(
    ...
    `${GENERATED_FILE_HEADER}export type Exception =
...
`
  ...
  for (const [name, message] of Object.entries(exceptions)) {
    ...
    writeFile(
      ...
      `${GENERATED_FILE_HEADER}import { buildFunctionOperator } from '@core/operators/operators.js';
